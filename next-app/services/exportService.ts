...
export async function generateDocx(messages: ExportMessage[], title?: string): Promise<Buffer> {
  ...
  children.push(
    new Paragraph({
      children: [
        new TextRun({ text: 'Generated by GRACE AI  ·  ', size: 18, font: 'Calibri', color: '888888' }),
...
export async function generatePptx(
  ...
  const reportTitle = title || 'GRACE AI';
  const pptx = new PptxGenJS();

  pptx.author = 'GRACE AI';
  ...
  creditsSlide.addText('Generated by GRACE AI', {
